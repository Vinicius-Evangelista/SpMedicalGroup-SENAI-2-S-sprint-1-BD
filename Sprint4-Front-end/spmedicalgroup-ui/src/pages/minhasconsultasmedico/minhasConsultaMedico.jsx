...
export default function MinhasConsultasMedico() {
    ...
    function BuscarMinhasConsutas() {
        ...
        axios('https://localhost:5001/api/Medicos/listar', {
                                ...
                                return (
                                    <div key = {consulta.idAgendamento} className="consulta">
                                        ...
                                        <div className="box-dados-consulta">
                                            ...
                                            <Link className="button-ver-consulta" to = {`/adicionardescricao/${consulta.idAgendamento}`}>
                                                Adicionar Descrição
                                            </Link>
                                        </div>
                                    </div>
